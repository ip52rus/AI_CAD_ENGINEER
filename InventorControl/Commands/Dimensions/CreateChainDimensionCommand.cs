...
public sealed class CreateChainDimensionCommand : IInventorCommand
{
    private readonly Inventor.Application _inventor;

    public CreateChainDimensionCommand(Inventor.Application inventor)
    {
    ...
    public string Execute(JsonElement root)
    {
        ...
        {
            return CreateError("Invalid chain dimension input.", diagnostics);
        }
        ...
        try
        {
            ...
            ChainDimensionSet dimensionSet =
            ...
            {
                capability = "create_chain_dimension",
        ...
        catch (Exception exception)
        {
            diagnostics.Add(new
            {
                scope = "ChainDimensionSets.Add",
                message = exception.Message,
                exceptionType = exception.GetType().FullName
            });

            return CreateError("Failed to create chain dimension.", diagnostics);
        }
    }
        ...
        List<object> diagnostics)
    {
        ...
        {
            diagnostics.Add(new { scope = "ChainDimensionSet.GetReferenceKey", message = exception.Message, exceptionType = exception.GetType().FullName });
            return null;
        }
    }
