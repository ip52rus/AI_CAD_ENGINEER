...
public class CreateDiameterDimensionCommand
    : IInventorCommand
{
    private readonly Inventor.Application
        _inventor;

    public CreateDiameterDimensionCommand(
        ...
        JsonElement root)
    {
        ...
        if (!isCircular)
        {
            return DimensionCommandSupport
                .CreateError(
                    "Диаметральный размер можно создать " +
        ...
        catch (Exception exception)
        {
            return DimensionCommandSupport
                .CreateError(
                    "Не удалось создать диаметральный размер.",
                    exception.Message);
        }
    }
}
