...
public sealed class ClearGeneralDimensionModelValueOverrideCommand : IInventorCommand
{
    private readonly Inventor.Application _inventor;

    public ClearGeneralDimensionModelValueOverrideCommand(Inventor.Application inventor)
    {
    ...
    public string Execute(JsonElement root)
    {
        ...
        {
            return CreateError("Invalid clear general dimension model value override input.", diagnostics);
        }
        ...
        {
            diagnostics.Add(new { scope = "GeneralDimension.ModelValueOverridden.Clear", message = exception.Message, exceptionType = exception.GetType().FullName, dimensionIndex });
            return CreateError("Failed to clear general dimension model value override.", diagnostics);
        }

        return CreateSuccess(new
        {
            capability = "clear_general_dimension_model_value_override",
