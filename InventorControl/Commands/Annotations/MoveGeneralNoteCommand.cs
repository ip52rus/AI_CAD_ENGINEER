...
public sealed class MoveGeneralNoteCommand : IInventorCommand
{
    private readonly Inventor.Application _inventor;

    public MoveGeneralNoteCommand(Inventor.Application inventor)
    {
        ArgumentNullException.ThrowIfNull(inventor);
        _inventor = inventor;
    }

    public string Name => "move_general_note";
    ...
    public string Execute(JsonElement root)
    {
        ...
        {
            return GeneralNoteCommandSupport.CreateError("Invalid move_general_note input.", diagnostics);
        }
        ...
        {
            diagnostics.Add(new { scope = "GeneralNote.Position.Set", message = exception.Message, exceptionType = exception.GetType().FullName, noteIndex });
            return GeneralNoteCommandSupport.CreateError("Failed to move general note.", diagnostics);
        }
